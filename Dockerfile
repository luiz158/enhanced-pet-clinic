...
COPY /volumes/jenkins/jobs/PACKAGE/workspace/enhanced-pet-clinic-exec.jar	/tmp/pet-clinic
# GET entry point script running server and client binaries
COPY /volumes/jenkins/jobs/PACKAGE/workspace/startup.sh /tmp/pet-clinic
